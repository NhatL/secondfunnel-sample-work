(function ($) {
    ...
    $(document).ready(function () { // ternary operator and comma expressions are bad form.
        $("#show-header-bar").on("click", function () {
            $("#show-header-bar").hasClass("open") ?
                ($(".header-bar").attr("style", "top: -200px"), $("#show-header-bar").removeClass("open")) :
                ($(".header-bar").attr("style", "top: 42px"), $("#show-header-bar").addClass("open"));
        }), $("#show-right-info-bar").on("click", function () {
            $("#show-right-info-bar").hasClass("move") ?
